...
export default function AppLayout() {
  ...
  return (
    <div className="min-h-screen bg-surface-50 dark:bg-[#080b12] text-surface-900 dark:text-surface-50 transition-colors duration-300 font-sans selection:bg-brand-500/30">
      <Sidebar isOpen={sidebarOpen} onClose={() => setSidebarOpen(false)} />

      {/* Main Content Area */}
      <div className="lg:pl-[256px] flex flex-col min-h-screen transition-all duration-300 ease-in-out">
